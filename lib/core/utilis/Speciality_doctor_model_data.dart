import 'package:cure_health_app/features/homeScreen/model/speciality_doctor_model.dart';

List<SpecialityDoctorModel> specialitydata = [
  SpecialityDoctorModel(
      specialityImage: "assets/images/physicians.webp",
      specialityName: "Physicians",
  ...
  SpecialityDoctorModel(
      specialityImage: "assets/images/dermatologist.jpg",
  ...
  SpecialityDoctorModel(
      specialityImage: "assets/images/Pediatricians.jpg",
      specialityName: "Pediatricians",
      specialityRequirement:
  ...
  SpecialityDoctorModel(
      specialityImage: "assets/images/opthalmologists.webp",
      specialityName: "Opthamologists",
      specialityRequirement:
